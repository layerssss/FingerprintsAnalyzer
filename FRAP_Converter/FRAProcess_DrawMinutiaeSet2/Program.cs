...
namespace FRAProcess_DrawMinutiaeSet2
{
    class Program
    {
        static int Main(string[] args)
        {
            return FRAProcess.FRAProcess.Execute(new FRAProcess_DrawMinutiaeSet2Process(), args);
        }
    }
    class FRAProcess_DrawMinutiaeSet2Process : FRAProcess.FRAProcess
    {
        ...
        public override void Procedure()
        {
            ...
            this.MS.ForEach(tm =>
            {
                tm.Location.Draw(this.bmp.BitmapObject, System.Drawing.Color.Red);
            });
        }
    }
