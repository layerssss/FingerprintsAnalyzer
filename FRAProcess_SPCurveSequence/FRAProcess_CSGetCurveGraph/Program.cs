...
namespace FRAProcess_CSGetCurveGraph
{
    class Program
    {
        static int Main(string[] args)
        {
            return FRAProcess.FRAProcess.Execute(new FRAProcess_CSGetCurveGraphProcess(), args);
        }
    }
    class FRAProcess_CSGetCurveGraphProcess : FRAProcess.FRAProcess
    {
